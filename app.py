...
CORS(app, origins=['http://localhost:3000/', 'https://fuseclockfront.herokuapp.com/'], supports_credentials=True)
CORS(user, origins=['http://localhost:3000/', 'https://fuseclockfront.herokuapp.com/'], supports_credentials=True)
CORS(timesheet, origins=['http://localhost:3000/', 'https://fuseclockfront.herokuapp.com/'], supports_credentials=True)
